...
funcLoadType = function(numOfType) {
  ...
  // $.ajax({
  //   "method": "GET",
  //   'url': "../data-base/apartments/type" + numOfType + "/description-apartment.json",
  //   'success': function(data){
  //     if (data.paragraf) {
  ...
  $.ajax({
    ...
    'success': function(data){
      ...
      $('.apartment').click(function(event){
        window.location.href = "/choose/apartment/?num=" + $(this).attr("data-apartment-id");
      })
